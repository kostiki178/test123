...
mysql -u root  --execute="CREATE DATABASE $database character set utf8 collate utf8_bin;"
mysql -u root  --execute="GRANT ALL PRIVILEGES ON $database.* TO '$user_wp'@'localhost' IDENTIFIED BY '$pass_wp';FLUSH PRIVILEGES;"
